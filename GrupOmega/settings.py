"""
Django settings for GrupOmega project.
...
SECRET_KEY = 'django-insecure-1u@+bg+&ig($ww$g87xz63asd4i#awabq5xq+7m_j(u3zfgxur'
...
WSGI_APPLICATION = 'GrupOmega.wsgi.application'
